			...
			<AnimatePresence>
				{
					isVisible && (
						<motion.button
							...
							exit={{ opacity: 0 }}
							onClick={scrollToTop}
							className="fixed md:bottom-[120px] bottom-24 z-40 md:right-12 right-4 p-2 rounded-full bg-theme-50 text-theme-400 hover:bg-theme-400 hover:text-white transition-colors duration-200"
