	...
	return (
		<section className="relative z-10 pt-10 pb-10 min-h-[500px]">
			...
			<div className="container mx-auto mb-10 animate-slideInUp-2">
				...
				<p className="mb-3">Nous collectons certaines informations lorsque vous utilisez nos services, notamment :</p>
				<ul>
				...
				<p className="mb-3">Nous ne partageons pas vos données personnelles avec des tiers, sauf dans les cas suivants :</p>
				<ul>
				...
				<p>Nous mettons en place des mesures de sécurité conformes aux standards de l’industrie pour protéger vos données contre les accès non autorisés, la modification ou la suppression.</p>
				<h2 className="font-NexaHeavy text-2xl mt-8">5. Durée de conservation</h2>
				<p>Vos données sont conservées aussi longtemps que nécessaire pour fournir nos services et respecter les obligations légales.</p>
				<h2 className="font-NexaHeavy text-2xl mt-8">6. Vos droits</h2>
				<p className="mb-3">Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez de droits sur vos données :</p>
				<ul className="mb-3">
					<li>- Accès, rectification et suppression de vos données</li>
					<li>- Opposition ou limitation du traitement</li>
					<li>- Portabilité de vos données</li>
				</ul>
				<p>Pour exercer vos droits, contactez-nous à [adresse e-mail de contact].</p>
				<h2 className="font-NexaHeavy text-2xl mt-8">7. Cookies et technologies de Suivi</h2>
				<p>Nous utilisons des cookies pour améliorer l’expérience utilisateur et analyser l’utilisation de notre plateforme. Vous pouvez gérer vos préférences via les paramètres de votre navigateur.</p>
				<h2 className="font-NexaHeavy text-2xl mt-8">8. Modifications de la politique de Confidentialité</h2>
				<p>Nous pouvons modifier cette politique à tout moment. Les modifications seront publiées sur cette page avec une indication de la date de mise à jour.</p>
				<h2 className="font-NexaHeavy text-2xl mt-8">9. Contact</h2>
				<p>Pour toute question, contactez-nous à la page <Link href="/contact" className="underline font-NexaHeavy">Contact</Link></p>
			</div>
		</section>
	);
};
