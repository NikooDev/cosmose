				...
				<div className="mt-10">
					...
					<div className="flex gap-10 relative">
						...
						<div className="bg-theme-50/10 w-full flex justify-center items-center flex-col backdrop-blur-lg py-6 px-4 relative z-20 rounded-3xl border border-theme-50/10">
							...
							<p className="text-center">Les équipes dispersées à travers des expériences collaboratives uniques,
						...
						<div className="bg-theme-50/10 w-full flex justify-center items-center flex-col backdrop-blur-lg py-6 px-4 relative z-20 rounded-3xl border border-theme-50/10">
							...
							<p className="text-center">Chaque membre de l'équipe dans une aventure immersive, favorisant ainsi la
						...
						<div className="bg-theme-50/10 w-full flex justify-center items-center flex-col backdrop-blur-lg py-6 px-4 relative z-20 rounded-3xl border border-theme-50/10">
							...
							<p className="text-center">Les collaborateurs avec des activités ludiques et interactives, offrant ainsi
