		...
		<svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 162.57 91.83">
			<g>
				...
				<motion.circle
					...
					strokeWidth="0.5"
					animate={{
						pathLength: [0, 1], // Définit le chemin parcouru
					}}
					transition={{
						duration: 3, repeat: Infinity, // Répète l'animation indéfiniment
						repeatDelay: 0.5, // Pause entre les répétitions
						ease: "easeInOut", // Type d'accélération/décélération
					}}
					style={{
						pathLength: 0, // La progression commence à 0
					}}
				/>
				...
				/>
				<path style={{fill: color}} d="M154.46.4c-5.43-1.44-10.52,1.03-12.02,6.67-1.9,7.15,4.11,10.72,7.17,11.19-1.4,2.55-3.21,4.16-5.46,5.17,1.63,2.32,2.98,4.85,4.03,7.51,6.69-3.08,12.13-9.69,13.81-16.01,2.15-8.14-2-13.07-7.53-14.53Z"/>
			</g>
		</svg>
	);
}
