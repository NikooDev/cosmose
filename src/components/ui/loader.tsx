...
const Loader: React.FC<LoaderInterface> = ({
  ...
  return (
		<div className={twMerge('flex items-center justify-center bg-theme-50/10 border border-theme-50/10 rounded-full', className)} style={{ width: (width + 20)+'px', height: (height + 20)+'px' }}>
